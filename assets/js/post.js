let zz =
  '<div style="color:#e6a23c;font-size:15px"> ' +
  ...
  '</div> ' +
  '<div style="padding-left: 28px;padding-bottom:10px">部分素材来自网络，若不小心影响到您的利益，请联系 <a href="mailto:lichenghao.vip@qq.com" target="_bank" style="color:#2097F3"> lichenghao.vip@qq.com </a>删除 ! ^_^</div> ' +
  '</div> '
document.querySelector('article').insertAdjacentHTML('afterbegin', zz)

$(document).ready(function () {
  var links = $('.post-content a:not(.btn):not(.headerlink)')
  links.each(function () {
